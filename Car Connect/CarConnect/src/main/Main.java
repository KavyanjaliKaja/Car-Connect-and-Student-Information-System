...
public class Main {
	...
	public static void main(String args[])  {
		...
		do {
			...
			System.out.println("Hi! welcome to CarConnect");
			System.out.println("Please enter 1 if you are a customer and enter 2 if you are an admin press 3 to exit the application :");
			choice=sc.nextInt();
			switch(choice) {
			case 1:
				try {
				System.out.println("Hi customer ");
				System.out.println("Are you new or do you have Carconnect account");
				System.out.println("If you are new then press 1 if you are previous customer then press 2 ");
